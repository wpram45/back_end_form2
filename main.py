    ...
    if form_adi=="Form30":
      ...
      #form 31'in ajaxını değiştirince bozuluyor      
        ...
        try:
            ...
            ogrencikayittarihi=gelenData["ogrencikayittarihi"] if "ogrencikayittarihi" in gelenData.keys() else ""
            ...
            cursor = mysql.connection.cursor()
            sorgu33="INSERT INTO form33 VALUES(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)"
